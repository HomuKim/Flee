$(document).ready(function(){
	...
	var obj_wrap=$(".visual .popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".visual .popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".visual .popup ul li");
	...
	var ctrl_next = $(".popup .next");
	var ctrl_prev = $(".popup .prev");
	var ctrl_stop = $(".popup .stop");
	var ctrl_play = $(".popup .play");
	...
	var paging_obj = $(".visual .popup .btn_group .paging button");
