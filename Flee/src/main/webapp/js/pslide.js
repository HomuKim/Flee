$(document).ready(function(){
	...
	var obj_wrap=$(".pvisual .popup2");
	//움직일 오브젝트의 이름
	var obj_name = $(".pvisual .popup2 ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".pvisual .popup2 ul li");
	...
	var ctrl_next = $(".popup2 .next");
	var ctrl_prev = $(".popup2 .prev");
	...
	var paging_obj = $(".pvisual .popup2 .btn_group .paging button");
