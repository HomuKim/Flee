$(document).ready(function(){
	...
	$(window).scroll(function(){//스크롤 될 때 마다
		scrolling = $(window).scrollTop();
		scroll_lnb();
		//console.log(scrolling);
	});
	
	$(window).resize(function(){//브라우저사이즈가 변경 될 때 마다
	...
	/*
		페이지가 일정 값 이상 스크롤 되면 lnb에 scroll이라는 클래스 추가
		얼마나 스크롤 되면?
		lnb에 준 top값(397) - scroll 클래스가 들어간 lnb의 top의 값(69) = 328
		모바일이였을 때
		243px - 50px = 193px
	*/
	var lnb_top;
	...
	*/
	...
	/* 
		모바일에서 메뉴닫기로 사라진 .lnb .depth2 ul을 pc에서 보이게... jquery로 show/hide로 처리한거는 jquery로 제어해야함
